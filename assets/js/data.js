...
window.SITE = {
  ...
  products: [
    ...
    { id:"me-completao-trianual", group:"residentes-sba", track:"extensivo", family:"completao", duration:"trianual", name:"ME Completão Trianual", tagline:"Do ME1 ao ME3 em um só plano — 3 anos de acesso.", badge:{text:"Melhor custo-benefício",type:"hot"}, featured:true, price:null,
      feats:["Todos os módulos ME1, ME2 e ME3","3 anos de acesso completo","Banco de questões + simulados","Atualizações incluídas"] },
    { id:"me-completao-bianual", group:"residentes-sba", track:"extensivo", family:"completao", duration:"bianual", name:"ME Completão Bianual", tagline:"Cobertura completa dos módulos ME em 2 anos.", price:null,
      feats:["Módulos ME1, ME2 e ME3","2 anos de acesso","Banco de questões + simulados"] },
    { id:"me-completao-anual", group:"residentes-sba", track:"extensivo", family:"completao", duration:"anual", name:"ME Completão Anual", tagline:"Todos os módulos ME em 1 ano de acesso.", price:null,
      feats:["Módulos ME1, ME2 e ME3","1 ano de acesso","Banco de questões + simulados"] },
    { id:"me1-anual", group:"residentes-sba", track:"extensivo", family:"modulo", year:"r1", duration:"anual", name:"ME1 Anual", tagline:"Foco no primeiro módulo da trilha ME.", price:null,
    ...
    { id:"me2-anual", group:"residentes-sba", track:"extensivo", family:"modulo", year:"r2", duration:"anual", name:"ME2 Anual", tagline:"Foco no segundo módulo da trilha ME.", price:null,
      feats:["Conteúdo completo do ME2","1 ano de acesso","Questões comentadas"],
      tiers:[ {name:"Regular", price:null, note:"Aulas + material + questões"}, {name:"Elite", price:null, note:"Regular + mentorias e extras", elite:true} ] },
    { id:"me3-anual", group:"residentes-sba", track:"extensivo", family:"modulo", year:"r3", duration:"anual", name:"ME3 Anual", tagline:"Foco no terceiro módulo da trilha ME.", price:null,
      feats:["Conteúdo completo do ME3","1 ano de acesso","Questões comentadas"],
      tiers:[ {name:"Regular", price:null, note:"Aulas + material + questões"}, {name:"Elite", price:null, note:"Regular + mentorias e extras", elite:true} ] },
    { id:"tsa-me-anual", group:"residentes-sba", track:"extensivo", family:"tsa", duration:"anual", name:"TSA ME Anual", tagline:"Trilha TSA dentro do contexto ME — 1 ano.", price:null,
      feats:["Conteúdo TSA orientado ao ME","1 ano de acesso","Simulados específicos"] },
    { id:"tsa-me-bianual", group:"residentes-sba", track:"extensivo", family:"tsa", duration:"bianual", name:"TSA ME Bianual", tagline:"Trilha TSA no contexto ME — 2 anos.", price:null,
      feats:["Conteúdo TSA orientado ao ME","2 anos de acesso","Simulados específicos"] },
    { id:"tsa-me-trianual", group:"residentes-sba", track:"extensivo", family:"tsa", duration:"trianual", name:"TSA ME Trianual", tagline:"Trilha TSA no contexto ME — 3 anos.", price:null,
    ...
    { id:"tea-trianual", group:"residentes-mec", track:"extensivo", family:"tea", duration:"trianual", name:"TEA Trianual", tagline:"Preparação TEA distribuída em 3 anos.", badge:{text:"Mais tempo de acesso",type:"primary"}, featured:true, price:null,
      feats:["Trilha TEA completa","3 anos de acesso","Banco de questões + simulados","Atualizações incluídas"] },
    { id:"tea-bianual", group:"residentes-mec", track:"extensivo", family:"tea", duration:"bianual", name:"TEA Bianual", tagline:"Preparação TEA em 2 anos.", price:null,
      feats:["Trilha TEA completa","2 anos de acesso","Banco de questões + simulados"] },
    { id:"tea-anual", group:"residentes-mec", track:"extensivo", family:"tea", duration:"anual", name:"TEA Anual", tagline:"Preparação TEA intensiva em 1 ano.", price:null,
